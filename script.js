...
const i18nData = {
  'zh-CN': {
    ...
    toolbarGroups: '分类管理',
    toolbarNewGroup: '新增分类…',
    addGroup: '添加',
    linkGroup: '分组',
    linkGroupPh: '例如：常用 / 工作 / 学习',
    linkIcon: '图标 URL（可选）',
  ...
  'zh-TW': {
    ...
    todoInput: '新增待辦…',
    todoClearDone: '清除已完成',
    toolbarSettings: '工具列設定',
    toolbarGroups: '分類管理',
    toolbarNewGroup: '新增分類…',
    addGroup: '新增',
    linkGroup: '分組',
    linkGroupPh: '例如：常用 / 工作 / 學習',
    linkIcon: '圖示 URL（可選）',
  ...
  'zh-WY': {
    ...
    todoInput: '添待辦…',
    todoClearDone: '清已竟',
    toolbarSettings: '工具列之設',
    toolbarGroups: '分類治',
    toolbarNewGroup: '添類…',
    addGroup: '添',
    linkGroup: '類',
    linkGroupPh: '如：常用 / 作業 / 學問',
    linkIcon: '圖示網址（或）',
    linkIconPh: '圖示之址',
    greetMorning: '晨安',
    clockFontSize: '鐘文大小',
  ...
  'en': {
    ...
    weather: 'Weather',
    weatherEdit: 'Settings',
    weatherCity: 'City',
    weatherUnset: 'No city set',
    weatherLoading: 'Loading…',
    weatherError: 'Weather unavailable',
    weatherRefresh: 'Refresh',
    todo: 'To-do',
    todoInput: 'Add a to-do…',
    todoClearDone: 'Clear completed',
    toolbarSettings: 'Toolbar settings',
    toolbarGroups: 'Manage categories',
    toolbarNewGroup: 'Add category…',
    addGroup: 'Add',
    linkGroup: 'Folder',
    linkGroupPh: 'e.g. Favorites / Work / Study',
  ...
  'ja': {
    ...
    todo: 'ToDo',
    todoInput: 'ToDo を追加…',
    todoClearDone: '完了をクリア',
    toolbarSettings: 'ツールバー設定',
    toolbarGroups: 'カテゴリ管理',
    toolbarNewGroup: 'カテゴリを追加…',
    addGroup: '追加',
    linkGroup: 'フォルダ',
    linkGroupPh: '例：お気に入り / 仕事 / 学習',
    linkIcon: 'アイコンURL（任意）',
  ...
  'ru': {
    ...
    weather: 'Погода',
    weatherEdit: 'Настройки',
    weatherCity: 'Город',
    weatherUnset: 'Город не задан',
    weatherLoading: 'Загрузка…',
    weatherError: 'Погода недоступна',
    weatherRefresh: 'Обновить',
    todo: 'Задачи',
    todoInput: 'Добавить задачу…',
    todoClearDone: 'Очистить выполненные',
    toolbarSettings: 'Настройки панели',
    toolbarGroups: 'Управление категориями',
    toolbarNewGroup: 'Добавить категорию…',
    addGroup: 'Добавить',
    linkGroup: 'Папка',
    linkGroupPh: 'например: Избранное / Работа / Учёба',
